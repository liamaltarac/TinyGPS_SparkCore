...
#define _GPGSA_TERM   "GPGSA"   //This was added by : Liam Altarac.  GPS receiver operating mode, active satellites
//used in the position solution, and DOP values.
#define _GPGSV_TERM   "GPGSV"   //This was added by: Liam Altarac. The number of GPS satellites in view satellite ID
//numbers, elevation, azimuth, and SNR values.
#define _GPVTG_TERM   "GPVTG"   //This was added by: Liam Altarac.   Course and speed information relative to the
//ground.
